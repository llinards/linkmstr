<x-layouts.app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl py-4">
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            <div
                class="bg-white overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 dark:bg-zinc-800 p-6">
                <div class="flex flex-col items-center justify-center">
                    <div class="rounded-full bg-blue-100 p-3 dark:bg-blue-900">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-blue-500 dark:text-blue-300"
                    ...
                    <a href="{{ route('links.index') }}"
                       class="mt-4 text-sm text-blue-600 hover:underline dark:text-blue-400" wire:navigate>View all
                        links →</a>
                </div>
            </div>
            <div
                ...
                <div class="flex flex-col items-center justify-center">
                    <div class="rounded-full bg-green-100 p-3 dark:bg-green-900">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-green-500 dark:text-green-300"
                             fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('links.create') }}"
                       class="mt-4 text-sm text-blue-600 hover:underline dark:text-blue-400" wire:navigate>Create new
                        link →</a>
                </div>
            </div>
            <div
                ...
                <div class="flex flex-col items-center justify-center">
                    <div class="rounded-full bg-purple-100 p-3 dark:bg-purple-900">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-purple-500 dark:text-purple-300"
                             fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @if ($topLink)
                        ...
                        <a href="{{ route('links.stats', $topLink) }}"
                           class="mt-4 text-sm text-blue-600 hover:underline dark:text-blue-400" wire:navigate>View
                            statistics →</a>
                    @else
                        <p class="mt-2 text-gray-500 dark:text-gray-400">No links yet</p>
                        <a href="{{ route('links.create') }}"
                           class="mt-4 text-sm text-blue-600 hover:underline dark:text-blue-400" wire:navigate>Create
                            first link →</a>
                    @endif
                </div>
            </div>

                ...
                <tr class="bg-white border-b dark:bg-zinc-800 dark:border-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-700">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            ...
                            <flux:button wire:click="copyToClipboard({{ $link->id }})" size="xs" variant="ghost">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex flex-col items-start space-y-2">
                            ...
                            <flux:switch :checked="$link->is_active && !$isExpired"
                                         :disabled="$isExpired"
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center space-x-2">
                            <!-- Edit Icon -->
                            <flux:button href="{{ route('links.edit', $link) }}" size="xs" variant="ghost"
                                         wire:navigate>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20"
                                     fill="currentColor">
                                    <path
                            ...
                            <!-- Stats Icon -->
                            <flux:button href="{{ route('links.stats', $link) }}" wire:navigate size="xs"
                                         variant="ghost">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20"
                                     fill="currentColor">
                                    <path
                            ...
                            <!-- Delete Icon -->
                            <flux:button wire:confirm="Are you sure?" wire:click="deleteLink({{ $link->id }})"

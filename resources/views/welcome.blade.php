        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="text-center p-8 rounded-xl bg-zinc-50 dark:bg-zinc-800">
                    ...
                    <p class="text-zinc-600 dark:text-zinc-400">Get insights into click performance, geographic data,
                        and
                ...
                <div class="text-center p-8 rounded-xl bg-zinc-50 dark:bg-zinc-800">
                    ...
                    <p class="text-zinc-600 dark:text-zinc-400">Share links with your team, set permissions, and
                        collaborate
    ...
    <section class="py-20 bg-zinc-50 dark:bg-zinc-950">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <!-- Starter Plan -->
                <div
                    class="bg-white dark:bg-zinc-900 rounded-xl shadow-lg p-8 border border-zinc-200 dark:border-zinc-800">
